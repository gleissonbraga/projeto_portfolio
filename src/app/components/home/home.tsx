...
//                 <a href="#" className="bg-white w-[20%] p-3 rounded-xl flex gap-2 justify-center font-extrabold text-[#F5080C] text-[96%]">
//                     Contato 
//                     <Image src="svg/telefone.svg" alt="Icon" width={18} height={18}/></a>

//                     <div>
//                 <img src="image/gleisson.png" alt="" />
//             </div>
//             </div>
        ...
        <section className="relative bg-[url('/image/background_home.jpeg')] bg-cover bg-center min-h-screen text-[#000000] justify-center align-middle w-[100%] gap-10">
            ...
            <div className="relative flex items-center justify-evenly pl-16 pt-36  gap-7 w-[100%] bg-[#00000055] pb-4 rounded-3xl">
                ...
                <div className="flex flex-col gap-4 w-[50%] pl-16 ">
                    ...
                    <a href="#" className="bg-white w-[180px] h-[54] p-3 rounded-xl flex items-center justify-center gap-2 font-extrabold text-[#F5080C] text-[22px] font-sans hover:scale-[1.1] transition-transform duration-500 ease-in-out">
                        Contato 
